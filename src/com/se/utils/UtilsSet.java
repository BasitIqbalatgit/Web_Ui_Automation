...
/// writen by basit---------------------------------------------------------
    @Step
    public static boolean areChildElementsClickable(By parentLocator) {
        List<WebElement> childElements = UtilsSet.findElements(parentLocator);
    ...
    // Add this method in the UtilsSet class
    @Step
    public static List<WebElement> findChildElements(By parentLocator) {
        WebElement parentElement = findElement(parentLocator);
